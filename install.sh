...
install_hive() {
	...
	echo "下载完成"
	echo "开始解压hive"
	tar zxvf /export/software/apache-hive-3.1.2-bin.tar.gz -C /export/server/
...
install_spark() {
  echo "开始安装spark"
	...
	echo "下载完成"
	echo "开始解压spark"
	tar zxvf /export/software/spark-3.1.2-bin-hadoop3.2.tgz -C /export/server/
...
install_finsh() {
  ...
  echo "========================"
	...
	echo "jdk+mysql_5.7+hadoop_3.3.0+zookeeper_3.4.6+hive_3.1.2+spark_3.1.2 已安装成功"
